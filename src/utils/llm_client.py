...
class LLMClient:
    ...
    def __init__(
        ...
        if not self.api_key:
            raise ValueError(
                "GOOGLE_API_KEY must be provided or set in environment variables"
            )
    ...
    def _get_default_responses(self) -> List[str]:
        ...
        return [
            ...
            """{
                ...
                "main_argument": "The defendant violated established legal principles by failing to comply with lawful orders.",
                "supporting_points": [
                    "Legal precedent supports strict interpretation of compliance requirements",
                ...
                "case_citations": [
                    {
                        ...
                        "relevance": "Establishes the standard for compliance",
                        "excerpt": "Defendants must demonstrate good faith compliance"
                    }
                ],
                "statutes_cited": ["18 U.S.C. § 1001"],
                "confidence_score": 0.75,
                "weaknesses_acknowledged": ["Defense may argue lack of intent"],
                "legal_reasoning": "The totality of circumstances demonstrates that the defendant's actions were knowing and willful, satisfying all elements of the offense."
            }""",
            # Defense argument
            """{
                "position": "defense",
                "main_argument": "The defendant acted in good faith and lacked the requisite intent for criminal liability.",
                "supporting_points": [
                    "No evidence of willful violation",
                    "Defendant made reasonable efforts to comply",
                    "Constitutional protections require proof beyond reasonable doubt"
                ],
                "case_citations": [
                    {
                        ...
                        "relevance": "Protects defendant's constitutional rights",
                        "excerpt": "Defendants have fundamental rights that must be protected"
                    }
                ],
                "statutes_cited": ["5th Amendment"],
                "confidence_score": 0.70,
                "weaknesses_acknowledged": ["Prosecution has circumstantial evidence"],
                "legal_reasoning": "The prosecution has failed to meet their burden of proof. The evidence is consistent with innocent conduct and good faith efforts at compliance."
            }""",
            # Moderator summary
            """Based on the arguments presented, both sides have made valid legal points. The prosecution has established a prima facie case, while the defense has raised reasonable doubt regarding intent. The key issue is whether the prosecution can prove willfulness beyond a reasonable doubt. Further evidence may be needed to resolve this question."""
        ]
